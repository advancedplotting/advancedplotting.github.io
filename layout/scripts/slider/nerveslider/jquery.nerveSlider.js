    ...
    $.fn.nerveSlider = function (userOptions) {
        ...
        return $(this).each(function () {
                ...
                if (options.slideTransition == "slide") {
                    ...
                    if (!$(self).find(".ns_selected").hasClass("ns_lastSlide")) {
                        ...
                        $(self).find(".ns_timer").fadeOut(options.slideTransitionSpeed / 2, options.slideTransitionEasing, function () {
                            $(self).find(".ns_timer").css({
                                "width": options.timerStartWidth
                            }).show().removeClass("ns_selected");
                        });
                        ...
                        if (options.simultaneousCaptions === true) {
                        ...
                        $(self).find(".ns_slidesTrack").animate(transarray, options.slideTransitionSpeed, options.slideTransitionEasing, function () {
                            if (sliderPaused === false) {
                                $(self).find(".ns_timer").animate({
                                    "width": options.timerEndWidth
                                }, options.slideTransitionDelay, "linear", function () {
                                    donextslide()
                                });
                            };
                            $(self).find(".ns_slideContainer.ns_selected .ns_caption").fadeIn(options.slideTransitionSpeed / 4, "swing");
                        ...
                        if (options.sliderHeightAdaptable === true) {
                            $(self).stop().animate({
                                "height": Math.max($(self).find(".ns_slideContainer.ns_selected img.ns_slideImage").height(), $(self).find(".ns_slideContainer.ns_selected .ns_slideContent").outerHeight())
                            }, options.slideTransitionSpeed, options.slideTransitionEasing);
                        };
                    } else {
                        $(self).find(".ns_slidesTrack").stop(false, false);
                        $(self).find(".ns_timer").stop();
                        ...
                        if (options.simultaneousCaptions === true) {
                            $(self).find(".ns_slideContainer.ns_decoy.ns_fs .ns_caption").fadeIn(options.slideTransitionSpeed / 4, "swing");
                        };
                        options.slideTransitionStart();
                    ...
                    if (!$(self).find(".ns_selected").hasClass("ns_lastSlide")) {
                        ...
                        $(self).find(".ns_dots .ns_dot.ns_selected").toggleClass("ns_selected").next(".ns_dot").addClass("ns_selected");
                        $(self).find(".ns_slideContainer.ns_selected").animate({
                            "opacity": 0
                        }, options.slideTransitionSpeed, options.slideTransitionEasing).toggleClass("ns_selected").next(".ns_slideContainer").addClass("ns_selected");
                        $(self).find(".ns_slideContainer").each(function () {
                            $(this).css({
                                "z-index": $(this).data("originalZIndex")
                            })
                        });
                        $(self).find(".ns_slideContainer.ns_selected").css({
                            "z-index": 45
                        });
                        if (options.simultaneousCaptions === true) {
                            $(self).find(".ns_slideContainer.ns_selected .ns_caption").fadeIn(options.slideTransitionSpeed / 4, "swing");
                        ...
                        $(self).find(".ns_slideContainer.ns_selected").animate({
                            "opacity": 1
                        }, options.slideTransitionSpeed, options.slideTransitionEasing, function () {
                            if (sliderPaused === false) {
                                $(self).find(".ns_timer").animate({
                                    "width": options.timerEndWidth
                                }, options.slideTransitionDelay, "linear", function () {
                        ...
                        $(self).find(".ns_slideContainer.ns_selected").animate({
                            "opacity": 0
                        }, options.slideTransitionSpeed, options.slideTransitionEasing).toggleClass("ns_selected").parent().find(".ns_firstSlide").addClass("ns_selected");
                        $(self).find(".ns_slideContainer").each(function () {
                            $(this).css({
                                "z-index": $(this).data("originalZIndex")
                            })
            ...
            function doprevslide() {
                ...
                if (options.slideTransition == "slide") {
                    ...
                    if (!$(self).find(".ns_selected").hasClass("ns_firstSlide")) {
                        ...
                        $(self).find(".ns_slideContainer.ns_selected").animate({
                            "opacity": 0
                        }, options.slideTransitionSpeed, options.slideTransitionEasing).toggleClass("ns_selected").prev(".ns_slideContainer").addClass("ns_selected");
                        $(self).find(".ns_slideContainer").each(function () {
                            $(this).css({
                                "z-index": $(this).data("originalZIndex")
                            })
                        ...
                        $(self).find(".ns_slideContainer.ns_selected").animate({
                            "opacity": 0
                        }, options.slideTransitionSpeed, options.slideTransitionEasing).toggleClass("ns_selected").parent().find(".ns_lastSlide").addClass("ns_selected");
                        $(self).find(".ns_slideContainer").each(function () {
                            $(this).css({
                                "z-index": $(this).data("originalZIndex")
                            })
            ...
            function pauseslide() {
                ...
                $(self).find(".ns_pauseButton div").animate({
                    "background-position-y": "100%"
                }, options.slideTransitionSpeed / 2, options.slideTransitionEasing);
            ...
            $(self).find(">a").each(function () {
                ...
                me.find(">img,>div").attr({
                    "data-linkto": goingto,
                    "data-linktarget": goingtarget,
                    "data-linkrel": goingrel
                });
            ...
            $(self).find("img").each(function () {
                ...
                if (me.parent().hasClass("ns_nerveSlider")) {
                    me.wrap("<div></div>");
                    me.parent().attr({
                        "data-slidecaption": me.attr("data-slidecaption"),
                        "data-linkto": me.attr("data-linkto"),
                        "data-linktarget": me.attr("data-linktarget"),
                        "data-linkrel": me.attr("data-linkrel"),
                        "data-imagescalemode": me.attr("data-imagescalemode")
                    });
            ...
            $(self).find(">div").each(function () {
                ...
                if (options.slideTransition == "slide") {
                    ...
                    $(self).find(".ns_slideContainer:first").css({
                        "position": "absolute",
                        "top": 0,
                        "left": 0,
                        "z-index": 45,
            ...
            if (options.slideTransitionDirection == "right") {
                $(self).find(".ns_slideContainer:not('.ns_decoy.ns_ls')").each(function () {
                    $(this).css({
                        "right": $(this).index() * 200 + "%"
                    });
                });
            } else if (options.slideTransitionDirection == "down") {
                $(self).find(".ns_slideContainer:not('.ns_decoy.ns_ls')").each(function () {
                    $(this).css({
                        "bottom": $(this).index() * 200 + "%"
                    });
                });
            };
            if ((!options.showLoadingOverlay === false)) {
                $(self).find(".ns_slideContainer").has(".ns_slideImage").each(function () {
                    ...
                    container.find("img.ns_slideImage").bind('load', function () {
                        ...
                        container.find("img.ns_slideImage").animate({
                            "opacity": 1
                        }, options.slideTransitionSpeed);
                        if (options.sliderHeightAdaptable === true) {
                            $(self).stop().animate({
                                "height": Math.max($(self).find(".ns_slideContainer.ns_selected img.ns_slideImage").height(), $(self).find(".ns_slideContainer.ns_selected .ns_slideContent").outerHeight())
                            }, options.slideTransitionSpeed, options.slideTransitionEasing);
            ...
            if (options.showTimer === false) {
                $(self).find(".ns_timer").css("bottom", $(self).find(".ns_timer").height() * -2)
            };
            ...
            if (options.showArrows === false) {
                $(self).find(".ns_nextButton, .ns_prevButton").hide()
            };
            $(self).append("<div class='ns_pauseButton'><div></div></div>");
            if (options.sliderAutoPlay === true) {
                $(self).find(".ns_pauseButton").one("click", pauseslide);
            };
            if (options.sliderAutoPlay === false) {
                pauseslide()
            };
            if (options.showPause === false) {
                $(self).find(".ns_pauseButton").hide()
            };
            ...
            $(self).find(".ns_dots .ns_dot").each(function () {
                ...
                if (options.slideTransition == "slide") {
                    $(this).data({
                        "jumpposition": (mypuredotnumber * -100) + "%"
                    });
            ...
            function dotwasclicked2(thedot) {
                ...
                $(self).find(".ns_dots .ns_dot.ns_selected").removeClass("ns_selected");
                thedot.addClass("ns_selected");
                $(self).find(".ns_slideContainer.ns_selected").removeClass("ns_selected").animate({
                    "opacity": 0
                }, options.slideTransitionSpeed, options.slideTransitionEasing);
            ...
            if ((options.startOnSlide > 1) && (options.startOnSlide <= numberofslides)) {
                ...
                if (options.slideTransition == "slide") {
                    ...
                    $(self).find(".ns_slideContainer").animate({
                        "opacity": 0
                    }, 0);
                    $(self).find(".ns_slideContainer.ns_selected").animate({
                        "opacity": 1
                    ...
                    if ((widthHasPercentSymbol === false) && (heightHasPercentSymbol === false)) {
                        ...
                        if ((widthHasPercentSymbol === true) && (heightHasPercentSymbol === false)) {
                            ...
                            $(window).resize(function () {
                                if (options.sliderKeepAspectRatio === true) {
                                    $(self).css({
                                        "max-width": $(self).height() * aspectRatio2,
                                        "width": "100%"
                                    });
                                } else {
                                    $(self).css({
